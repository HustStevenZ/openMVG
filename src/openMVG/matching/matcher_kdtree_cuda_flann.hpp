...
#ifndef OPENMVG_MATCHING_ARRAYMATCHER_KDTREE_CUDA_FLANN_H_
#define OPENMVG_MATCHING_ARRAYMATCHER_KDTREE_CUDA_FLANN_H_
...
class ArrayMatcher_Kdtree_cuda_Flann : public ArrayMatcher<Scalar, Metric>
{
  public:
  typedef typename Metric::ResultType DistanceType;

  ArrayMatcher_Kdtree_cuda_Flann() = default ; 

  virtual ~ArrayMatcher_Kdtree_cuda_Flann()  {
    _datasetM.reset();
    _index.reset();
  }
...
/**
  ...
  std::unique_ptr< flann::KDTreeCuda3dIndex<Metric> > _index;
